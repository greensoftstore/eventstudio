...
const ArrowLeft = () => <img src={toAbsoluteUrl("/assets/media/svg/arrow-left.svg")} alt="Arrow Left" style={{width: '10px'}} />;
const ArrowRight = () => <img src={toAbsoluteUrl("/assets/media/svg/arrow-right.svg")} alt="Arrow Right" style={{width: '10px'}} />;
